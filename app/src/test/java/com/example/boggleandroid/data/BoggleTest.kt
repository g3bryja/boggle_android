...
//        assertEquals(expectedTile, boggle.boardState.value.tiles[0])
//        assertEquals(expectedFound, boggle.playerState.value.found)
//    }
//
//    @Test
//    fun testGetNeighborsForCenter() {
//        val tile = boggle.boardState.value.tiles[5]
//        val expectedIndices = mutableListOf(0, 1, 2, 4, 6, 8, 9, 10)
//        val expected = mutableListOf<BoggleTile>()
//        for (i in expectedIndices) {
//            expected.add(boggle.boardState.value.tiles[i])
//        }
...
//        val tile = boggle.boardState.value.tiles[3]
...
//        val tile = boggle.boardState.value.tiles[12]
...
//
//        boggle.playerState.value.found[word] = false
